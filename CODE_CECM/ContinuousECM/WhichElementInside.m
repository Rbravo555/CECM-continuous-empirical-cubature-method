function [elemCONTAINER,POLYINFO] = WhichElementInside(xLOC,INDnear,VAR_SMOOTH_FE,IND_POLYG,POLYINFO,inew) ; 
if nargin == 0
    load('tmp.mat')
end
...
while ielem <= length(ELEMnear)
    ...
    [inELEM,onELEM,TriLocal] = IsInsideALL(xLOC,VAR_SMOOTH_FE,elemLOC,IND_POLYG,POLYINFO)  ;
