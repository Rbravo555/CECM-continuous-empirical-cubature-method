...
AUXVAR.DATA_from_MAIN = DefaultField(AUXVAR.DATA_from_MAIN,'AspectRatioPlotGraphLocationPointsVersusWeights',ASPEC_RATIO) ; 
ASPEC_RATIO = AUXVAR.DATA_from_MAIN.AspectRatioPlotGraphLocationPointsVersusWeights ; 
 daspect(ASPEC_RATIO) ; 
