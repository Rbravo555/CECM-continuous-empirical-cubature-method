...
while SALIR == 0 && iremove <=length(S_crit)
    ...
    TotalNumberIterations_all =  TotalNumberIterations_all + VARCnew.NumberOfIterationsTotal ; 
...
DATALOC.NumberOfTrialsForFindingViableRoute  = iremove ; 
DATALOC.TotalNumberIterations_all  = TotalNumberIterations_all ; 
